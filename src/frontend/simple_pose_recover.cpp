...
cv::Mat triangulateSimple(const cv::Mat& P1, const cv::Mat& P2, const cv::Point2f& pt1,
...
void simpleRecoverPose(const cv::Mat& E, const std::vector<cv::Point2f>& points1,
    ...
    std::vector<cv::Mat> P = {
        (cv::Mat_<double>(3, 4) << R1.at<double>(0, 0), R1.at<double>(0, 1), R1.at<double>(0, 2),
         t_.at<double>(0), R1.at<double>(1, 0), R1.at<double>(1, 1), R1.at<double>(1, 2),
         t_.at<double>(1), R1.at<double>(2, 0), R1.at<double>(2, 1), R1.at<double>(2, 2),
         t_.at<double>(2)),
        (cv::Mat_<double>(3, 4) << R2.at<double>(0, 0), R2.at<double>(0, 1), R2.at<double>(0, 2),
         t_.at<double>(0), R2.at<double>(1, 0), R2.at<double>(1, 1), R2.at<double>(1, 2),
         t_.at<double>(1), R2.at<double>(2, 0), R2.at<double>(2, 1), R2.at<double>(2, 2),
         t_.at<double>(2)),
        (cv::Mat_<double>(3, 4) << R1.at<double>(0, 0), R1.at<double>(0, 1), R1.at<double>(0, 2),
         -t_.at<double>(0), R1.at<double>(1, 0), R1.at<double>(1, 1), R1.at<double>(1, 2),
         -t_.at<double>(1), R1.at<double>(2, 0), R1.at<double>(2, 1), R1.at<double>(2, 2),
